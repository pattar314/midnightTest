            ...
            <form className='contact-form' onSubmit={formCollector}>
                ...
                <div className='name-input-group'>
                    <div className='another-name-class'>
                        <input type='text' id='first-name-text' name='firstName' onChange={handleChange('firstName')} value={formData['firstName']} />
                        <label htmlFor='first-name' className='sub-label'>First</label>
                        </div>                
                    <div className='another-name-class'>
                        <input type='text' id='last-name-text' name='lastName' onChange={handleChange("lastName")} value={formData['lastName']} />
                ...
                <input type='email' name='email' id='email-text' onChange={handleChange("email")} value={formData['email']} /><br/>
                <label htmlFor='message' className='form-label'><b><h3>Comment or Message</h3></b></label><br/>
                <textarea name='message' id='message-text' rows='10' cols='30' onChange={handleChange("message")} value={formData['message']} />
